    ...
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <ul className="space-y-6">
              {(t('glsofort.advantages.items', { returnObjects: true }) as string[]).map((advantage: string, index: number) => (
                <li key={advantage.slice(0, 20)} className="flex items-start bg-white rounded-lg p-6 shadow-md">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(t('glsofort.applications.areas', { returnObjects: true }) as Array<{title: string; description: string}>).map((area: {title: string; description: string}) => (
              <div key={area.title} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow text-center">
                ...
                <h3 className="text-xl font-bold text-[#264b69] mb-4">{area.title}</h3>
