    ...
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="bg-white text-green-600 hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold transition-colors block text-center"
              >
                {t("health.hero.buttons.consultation")}
              </Link>
              <Link
                to="/contact"
                className="border-2 border-white text-white hover:bg-white hover:text-green-600 px-8 py-3 rounded-lg font-semibold transition-colors block text-center"
              >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto pr-8 text-left">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#264b69] mb-2">
                    {t("health.overview.healthManagement.title")}
                  </h3>
                  <p className="text-gray-700">
                    {t("health.overview.healthManagement.description")}
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#264b69] mb-2">
                    {t("health.overview.geneticTesting.title")}
                  </h3>
                  <p className="text-gray-700">
                    {t("health.overview.geneticTesting.description")}
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#264b69] mb-2">
                    {t("health.overview.medicationInstruction.title")}
                  </h3>
                  <p className="text-gray-700">
                    {t("health.overview.medicationInstruction.description")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-[#264b69] mb-8 text-center">
              {t("health.packages.wes.title")}
            </h3>
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#264b69] mb-8 text-center">
              {t("health.packages.specialized.title")}
            </h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                {(
                  t("health.applications.families.items", {
                    returnObjects: true,
                  }) as string[]
                ).map((item: string) => (
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                {(
                  t("health.applications.individuals.items", {
                    returnObjects: true,
                  }) as string[]
                ).map((item: string) => (
                  <li key={item} className="flex items-start">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                {(
                  t("health.applications.children.items", {
                    returnObjects: true,
                  }) as string[]
                ).map((item: string) => (
                  <li key={item} className="flex items-start">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                {(
                  t("health.applications.seniors.items", {
                    returnObjects: true,
                  }) as string[]
                ).map((item: string) => (
                  <li key={item} className="flex items-start">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl">
            <div className="grid md:grid-cols-5 gap-8">
              {(
                t("health.process.steps", { returnObjects: true }) as Array<{
                  title: string;
                  description: string;
                }>
              ).map(
