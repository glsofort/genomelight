...
const News = () => {
  ...
  const featuredNews = t('news.featured.items', { returnObjects: true }) as Array<{
    title: string
    summary: string
    date: string
    category: string
  ...
  return (
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {featuredNews.map((news, index) => (
              <article key={news.title} className={`bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow ${index === 0 ? 'lg:col-span-2 lg:row-span-2' : ''}`}>
                ...
                <div className="p-6">
                  ...
                  <h3 className={`font-bold text-[#264b69] mb-3 ${index === 0 ? 'text-2xl' : 'text-xl'}`}>
                    {news.title}
                  </h3>
          ...
          {filteredRecentNews.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredRecentNews.map((news) => (
                <article key={news.title} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
      ...
      <section className="py-20 bg-[#264b69]">
        <div className="container mx-auto px-4">
          <div className="text-center text-white">
            <h2 className="text-3xl font-bold mb-4">订阅我们的资讯</h2>
            <p className="text-xl mb-8 opacity-90">获取GenomeLight最新动态和行业资讯</p>
